 ...
 * under the License.
 */
package com.smartblockscep.server.api.execution.query;
...
import static com.smartblockscep.server.api.execution.query.output.stream.OutputStream.OutputEventType.CURRENT_EVENTS;
...
public class OnDemandQuery implements SiddhiElement {
    ...
    public OnDemandQuery outStream(OutputStream outputStream) {
        ...
        if (outputStream != null && outputStream.getOutputEventType() == null) {
            outputStream.setOutputEventType(CURRENT_EVENTS);
        }
        return this;
    }
