...
import com.smartblockscep.server.api.aggregation.TimePeriod;
import com.smartblockscep.server.api.aggregation.Within;
import com.smartblockscep.server.api.annotation.Annotation;
import com.smartblockscep.server.api.annotation.Element;
import com.smartblockscep.server.api.definition.*;
import com.smartblockscep.server.api.execution.ExecutionElement;
import com.smartblockscep.server.api.execution.partition.*;
import com.smartblockscep.server.api.execution.partition.Partition;
import com.smartblockscep.server.api.execution.query.OnDemandQuery;
...
import com.smartblockscep.server.api.execution.query.input.handler.StreamFunction;
...
import com.smartblockscep.server.api.execution.query.input.store.InputStore;
import com.smartblockscep.server.api.execution.query.input.store.Store;
import com.smartblockscep.server.api.execution.query.input.stream.*;
import com.smartblockscep.server.api.execution.query.output.ratelimit.EventOutputRate;
import com.smartblockscep.server.api.execution.query.output.ratelimit.OutputRate;
import com.smartblockscep.server.api.execution.query.output.ratelimit.SnapshotOutputRate;
import com.smartblockscep.server.api.execution.query.output.ratelimit.TimeOutputRate;
import com.smartblockscep.server.api.execution.query.output.stream.*;
import com.smartblockscep.server.api.execution.query.selection.BasicSelector;
...
import com.smartblockscep.server.api.util.SiddhiConstants;
 ...
 */
public class BaseVisitorImpl extends SiddhiQLBaseVisitor {
